...
<footer class="footer section--logo section--logo_reverse" id="contact-us">
    <div class="container">
        ...
        <div class="footer__inner d-flex">
            <div class="footer__col col-100-xs">
                ...
                <div class="footer__form-wrap">
                    <?php echo do_shortcode('[contact-form-7 id="463dd48" title="Contact form"]'); ?>
                </div>
            </div>
            <div class="footer__col col-100-xs" data-aos="fade-left" data-aos-easing="ease-in-sine">
                            ...
                            <svg width="55" height="51" viewBox="0 0 55 51" fill="none"
                                ...
                                <defs>
                                    <clipPath id="clip0_1_99">
                                        <rect width="55" height="51" fill="#D6A43B"></rect>
                                    </clipPath>
                                </defs>
                            </svg>
                        </div>
                        <div class="contact-item__text-wrap">
                            <?php if (get_field("site_text-phone", "option") && get_field("site_phone-number", "option")): ?>
                                <?php echo get_field("site_text-phone", "option"); ?>
                                <a class="link"
                                    href="tel:<?php echo get_field("site_phone-number", "option"); ?>"><?php echo get_field("site_phone-number", "option"); ?></a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                <div class="footer__item footer__item--linledin">
                    <?php if (get_field('site_linkedin', "option")): ?>
                        <a href="<?= get_field('site_linkedin', "option")['url'] ?>">
                            <i class="fa-brands fa-linkedin fa-xl d-flex al-center" style="color: #d6a43b;"></i>
                            <?= get_field('site_linkedin', "option")['title'] ?>
                        </a>
                    <?php endif; ?>
                </div>
                <div class="footer__item footer__item--place">
                    <p>
                        <?php if (get_field("site_address", "option")): ?>
                            <?php echo get_field("site_address", "option"); ?>
                        <?php endif; ?>

                        <?php if (get_field("site_phone-number_2", "option")): ?>
                            <a
                                href="tel:<?php echo get_field("site_phone-number_2", "option"); ?>"><?php echo get_field("site_phone-number_2", "option"); ?></a>
                        <?php endif; ?>
                    </p>
                </div>
            </div>
        </div>
        <div class="copyrights-wrap d-flex jc-center">
            <?php if (get_field("site_descriptor", "option")): ?>
                <?php echo get_field("site_descriptor", "option"); ?>
            <?php endif; ?>
        </div>
    </div>
</footer>
